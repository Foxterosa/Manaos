...
#define CALIBER_PISTOL_ANTIQUE	"9mm"
#define CALIBER_PISTOL_MAGNUM_LARGE ".44 Magnum"

#define CALIBER_RIFLE			"5.56mm"
#define CALIBER_RIFLE_MILITARY  "5mm"
#define CALIBER_ANTIMATERIAL    ".50 MG"
