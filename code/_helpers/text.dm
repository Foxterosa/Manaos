...
/proc/pencode2html(t)
	...
	t = replacetext(t, "\[medlogo\]", "<img src = medlogo.png>")
	t = replacetext(t, "\[seclogo\]", "<img src = seclogo.png>")
	t = replacetext(t, "\[explogo\]", "<img src = explogo.png>")
	t = replacetext(t, "\[civlogo\]", "<img src = civlogo.png>")
	t = replacetext(t, "\[servlogo\]", "<img src = servlogo.png>")
	t = replacetext(t, "\[reslogo\]", "<img src = reslogo.png>")
	t = replacetext(t, "\[suplogo\]", "<img src = suplogo.png>")
	t = replacetext(t, "\[englogo\]", "<img src = englogo.png>")
	t = replacetext(t, "\[roblogo\]", "<img src = roblogo.png>")
...
/proc/html2pencode(t)
	...
	t = replacetext(t, "<img src = medlogo.png>", "\[medlogo\]")
	t = replacetext(t, "<img src = seclogo.png>", "\[seclogo\]")
	t = replacetext(t, "<img src = explogo.png>", "\[explogo\]")
	t = replacetext(t, "<img src = civlogo.png>", "\[civlogo\]")
	t = replacetext(t, "<img src = servlogo.png>", "\[servlogo\]")
	t = replacetext(t, "<img src = suplogo.png>", "\[suplogo\]")
	t = replacetext(t, "<img src = reslogo.png>", "\[reslogo\]")
	t = replacetext(t, "<img src = englogo.png>", "\[englogo\]")
	t = replacetext(t, "<img src = roblogo.png>", "\[roblogo\]")
