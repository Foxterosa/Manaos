...
GLOBAL_LIST_INIT(music_tracks, list(
	...
	"Why no reply" = /music_track/arabesque,
	"Curb your enthusiasm" = /music_track/curb,
	"Bandit radio" = /music_track/bandit,
	"Black holes" = /music_track/blackholes,
	"Black in black" = /music_track/blackinblack,
	"Mr.blue sky" = /music_track/bluesky,
	"Ciudad magica" = /music_track/ciudadmagica,
	"Domo - cafe" = /music_track/domo,
	"Doom - Kitchen Ace" = /music_track/doom,
	"Dear hearts of gentle people" = /music_track/fallout,
	"Fly me to the moon" = /music_track/flyme,
	"Gimme Shelter" = /music_track/gimmeshelther,
	"Space asshole" = /music_track/spaceasshole,
	"Put on your sunday clothes" = /music_track/sundayclothes,
	...
	"Somebody's Miami" = /music_track/somebodysmiami,
