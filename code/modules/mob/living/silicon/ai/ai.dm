...
/mob/living/silicon/ai/New(loc, var/datum/ai_laws/L, var/obj/item/device/mmi/B, var/safety = 0)
	...
	add_language(LANGUAGE_HUMAN_GAIAN, 1)
	add_language(LANGUAGE_GUTTER, 1)
	add_language(LANGUAGE_LEGALESE, 1)
	add_language(LANGUAGE_SPACER, 1)
	add_language(LANGUAGE_EAL, 1)
	...
	add_language(LANGUAGE_SERGAL, 1)
	add_language(LANGUAGE_SKRELLIAN, 1)
	add_language(LANGUAGE_GUTTER, 1)
	add_language(LANGUAGE_PRIMITIVE, 1)
	add_language(LANGUAGE_NABBER, 1)
	add_language(LANGUAGE_ROOTLOCAL, 1)
	add_language(LANGUAGE_ROOTGLOBAL, 1)
