...
/decl/hierarchy/skill/general/EVA/mech
	...
	levels = list("Ignorante" = "You are unfamiliar with exosuit controls, and if you attempt to use them you are liable to make mistakes.",
		"Entrenado" = "You are proficient in exosuit operation and safety, and can use them without penalties.")
