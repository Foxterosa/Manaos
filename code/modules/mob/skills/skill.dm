...
/decl/hierarchy/skill/organizational/finance
	...
	levels = list( "Ignorante"			= "Your understanding of money starts and ends with personal finance. While you are able to perform basico transactions, you get lost in the details, and can find yourself ripped off on occasion.<br>- You get some starting money. Its amount increases with level.<br>- You can use the verb \"Appraise\" to see the value of different objects.",
						"Basico"				= "You have some limited understanding of financial transactions, and will generally be able to keep accurate records. You have little experience with investment, and managing large sums of money will likely go poorly for you.",
...
/decl/hierarchy/skill/medical/chemistry
	ID = "chemistry"
	name = "Quimica"
	desc = "Tu experiencia con la mezcla de quimicos, y entendimiento de que efectos hacen. Esto no inclute el enetendimiento de que efecto tienen los quimicos sobre el cuerpo humano, como tal la habilidad de medicina es requerida para los quimicos medicos."
	levels = list( "Ignorante"			= "You know that chemists work with chemicals;Sabes que esos quimicos funcionan con you know that they can make medicine or poison or useful chemicals. You probably know what an element is and have a vague idea of what a chemical reaction is from some chemistry class in your high school days.",
						"Basico"				= "You can make basico chemicals or medication--things like space cleaner or anti-toxin. You have some training in safety and you won't blow up the lab... probably.<br>- You can safely use the industrial grinder but lose some ingredients. Its amount decreases with skill level.",
