...
/decl/hierarchy/skill/organizational/finance
	...
	levels = list( "Ignorante"			= "Tu entendimiento sobre el dinero empieza y acaba con tu finanza personal. Si bien puedes realizar transacciones basicas, te pierdes en los detalles. Y puedes terminar estafado alguna que otra vez. <br>- Tienes algo de dinero al empezar, que va aumentando segun tu nivel.<br>- Puedes usar el verbo \"Appraise\" para ver el valor de diferentes objetos.",
						...
						"Maestro"		= "Tienes un excelente conocimiento sobre la financia, You have an excellent knowledge of finance, a menudos haras brillantes inversiones y tendras una sensacion instintiva de la economia interestelar.Los instrumentos financieros seran como armas en tus manos. Es probable que tengas experiencia profesional en la industria financiera.")
...
/decl/hierarchy/skill/medical/medical
	ID = "medical"
	name = "Medicina"
	desc = "Cubre la comprension del cuerpo humano y la medicina. En un nivel bajo, esta habilidad te da un entendimiento basico de las aplicaciones comunes de medicina y una comprension aproximada de los dispositivos méedicos como el analizador de salud. En nivel alto, esta habilidad garantiza un conocimiento exacto de toda la medicina posible en la instalacio, asi como la capacidad del uso de dispositivos medicos complejos como el escaner corporal o el espectrometro de masas."
	levels = list( "Ignorante"			= "Sabes sobre primeros auxilios, como aplicar un vendaje o una pomada a una herida. Puedes usar el autoyector designado para el uso de civiles, probablemente leyendo las instrucciones impresas en el. Puedes notar cuando alguien se encuentra mal y necesita un doctor; puedes ver cuando alguien tiene un hueso roto, esta teniendo problemas en respirar, o esta inconsciente. Te puede costar diferenciar si esta inconsciente o muerto si lo miras desde lejos.<br>- Puedes usar los suministros de primero auxilios que se encuentran en los kits y bolsas, incluyendo autoinyectores.",
