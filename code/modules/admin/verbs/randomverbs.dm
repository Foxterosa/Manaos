...
/client/proc/admin_headset_message(mob/M, sender = null)
	...
	to_chat(H, "<span class='boldannounce'>Incoming priority transmission from [sender == "Syndicate" ? "your benefactor" : "Central Command"]. </span><span class = 'notice'> [input]  </span>")
